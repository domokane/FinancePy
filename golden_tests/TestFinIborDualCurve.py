...
def test_swapValuationExample():
    ...
    spot_days = 0
    settle_dt = value_dt.add_weekdays(spot_days)
    depo = IborDeposit(settle_dt, "6M", -0.2510 / 100.0, depo_dcc_type)
    depos.append(depo)

    fras = []
    fraDCCType = DayCountTypes.ACT_360

    fra = IborFRA(settle_dt.add_tenor("1M"), "6M", -0.2450 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("2M"), "6M", -0.2435 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("3M"), "6M", -0.2400 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("4M"), "6M", -0.2360 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("5M"), "6M", -0.2285 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("6M"), "6M", -0.2230 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("7M"), "6M", -0.2110 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("8M"), "6M", -0.1990 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("9M"), "6M", -0.1850 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("10M"), "6M", -0.1680 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("11M"), "6M", -0.1510 / 100.0, fraDCCType)
    fras.append(fra)
    fra = IborFRA(settle_dt.add_tenor("12M"), "6M", -0.1360 / 100.0, fraDCCType)
    fras.append(fra)
    ...
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "4Y", fixed_leg_type, 0.1315 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "5Y", fixed_leg_type, 0.2745 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "6Y", fixed_leg_type, 0.4135 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "7Y", fixed_leg_type, 0.5439 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "8Y", fixed_leg_type, 0.6652 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt, "9Y", fixed_leg_type, 0.7784 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = IborSwap(
        settle_dt,
    ...
    spot_days = 0
    settle_dt = value_dt.add_weekdays(spot_days)
    depo = IborDeposit(settle_dt, "1D", -0.3490 / 100.0, depo_dcc_type)
    depos.append(depo)
    ...
    swaps.append(swap)
    swap = OIS(
        settle_dt, "5Y", fixed_leg_type, 0.1285 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = OIS(
        settle_dt, "6Y", fixed_leg_type, 0.2590 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = OIS(
        settle_dt, "7Y", fixed_leg_type, 0.3830 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = OIS(
        settle_dt, "8Y", fixed_leg_type, 0.5020 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = OIS(
        settle_dt, "9Y", fixed_leg_type, 0.6140 / 100.0, fixed_freq_type, fixed_dcc_type
    )
    swaps.append(swap)
    swap = OIS(
        settle_dt,
