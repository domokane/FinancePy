...
def test_oas():
    ...
    oas = (
        bond.option_adjusted_spread(settle_dt, clean_price, libor_flat_curve)
        * 10000
    )
...
def test_cpn_types():
    ...
    bond = Bond(
        issue_dt, maturity_dt, coupon, freq_type, dc_type, cpn_type=cpn_type
    )
