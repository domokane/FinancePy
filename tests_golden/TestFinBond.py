...
def test_bond():
    ...
    # definition
    flat_curve = DiscountCurveFlat(settle_dt,
                                   ytm,
...
def test_oas():
    ...
    liborFlatCurve = DiscountCurveFlat(settle_dt, liborFlatRate,
                                       FrequencyTypes.SEMI_ANNUAL)

    # I specified face to be 100 - if face is 1 then this must be 0.99780842
    clean_price = 99.780842

    oas = bond.option_adjusted_spread(settle_dt, clean_price,
