...
def testConvergence():
    ...
    for numPaths in numPathsList:
        ...
        value_mc_fast = asianOption._value_mc_fast(valueDate,
                                                 stockPrice,
                                                 discountCurve,
                                                 dividend_curve,
                                                 model,
        ...
        value_mc_CV = asianOption.value_mc(valueDate,
                                         stockPrice,
                                         discountCurve,
                                         dividend_curve,
                                         model,
...
def testMCTimings():
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = asianOption.value_mc(valueDate,
                                      stockPrice,
                                      discountCurve,
                                      dividend_curve,
                                      model,
        ...
        start = time.time()
        value_mc_fast_CV = asianOption.value_mc(valueDate,
                                              stockPrice,
                                              discountCurve,
                                              dividend_curve,
                                              model,
