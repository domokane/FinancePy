...
def test_swapValuationExample():
    ...
    swap = FinIborSwapOLD(settlementDate, "2Y", fixedLegType, -0.1525/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "3Y", fixedLegType, -0.0185/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "4Y", fixedLegType, 0.1315/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "5Y", fixedLegType, 0.2745/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "6Y", fixedLegType, 0.4135/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "7Y", fixedLegType, 0.5439/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "8Y", fixedLegType, 0.6652/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "9Y", fixedLegType, 0.7784/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "10Y", fixedLegType, 0.8799/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "11Y", fixedLegType, 0.9715/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "12Y", fixedLegType, 1.0517/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "15Y", fixedLegType, 1.2369/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "20Y", fixedLegType, 1.3965/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "25Y", fixedLegType, 1.4472/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "30Y", fixedLegType, 1.4585/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "35Y", fixedLegType, 1.4595/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "40Y", fixedLegType, 1.4535/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "45Y", fixedLegType, 1.4410/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
    swap = FinIborSwapOLD(settlementDate, "50Y", fixedLegType, 1.4335/100.0, fixedFreqType, fixedDCCType); swaps.append(swap)
