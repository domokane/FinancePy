...
def test_bloombergPricingExample():
    ...
    libor_curve = FinIborSingleCurve(valuation_date, depos, fras, swaps, interpType, True)
...
#    print(oisCurve)
    ...
    liborDualCurve = FinIborDualCurve(valuation_date, oisCurve, depos, fras, swaps,
