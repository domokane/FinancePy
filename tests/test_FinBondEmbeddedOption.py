...
swap1 = IborSwap(settlement_date_matlab, "1Y", fixed_leg_type, 0.0350, fixedFreq, dcType)
swap2 = IborSwap(settlement_date_matlab, "2Y", fixed_leg_type, 0.0400, fixedFreq, dcType)
swap3 = IborSwap(settlement_date_matlab, "3Y", fixed_leg_type, 0.0450, fixedFreq, dcType)
...
def test_matlab_clean_price_from_discount_curve():
    v = bond_matlab.clean_price_from_discount_curve(settlement_date_matlab, discount_curve_matlab)
...
bond_quantlib = Bond(issue_date, maturity_date, coupon, freq_type, accrual_type)
...
def test_quantlib_clean_price_from_discount_curve():
    v = bond_quantlib.clean_price_from_discount_curve(settlement_date_quantlib, discount_curve_quantlib)
...
def test_quantlib_bk():
    ...
    v = puttableBond_quantlib.value(settlement_date_quantlib, discount_curve_quantlib, model)
