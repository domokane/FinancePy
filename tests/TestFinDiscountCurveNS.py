...
def test_FinNelsonSiegelCurve():
    ...
    curve_date = FinDate(6, 6, 2019)
    dates = curve_date.addYears(times)

    curve1 = FinDiscountCurveNS(curve_date, 1, 0, 0, tau)
    factor1loading = curve1.zeroRate(dates)
    curve2 = FinDiscountCurveNS(curve_date, 0, 1, 0, tau)
    factor2loading = curve2.zeroRate(dates)
    curve3 = FinDiscountCurveNS(curve_date, 0, 0, 1, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve1 = FinDiscountCurveNS(curve_date, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve2 = FinDiscountCurveNS(curve_date, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve3 = FinDiscountCurveNS(curve_date, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve4 = FinDiscountCurveNS(curve_date, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve5 = FinDiscountCurveNS(curve_date, beta1, beta2, beta3, tau)
