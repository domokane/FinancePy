...
def test_FinNumbaNumpySpeed(useSobol):
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = callOption.value_mc_NONUMBA_NONUMPY(valueDate, stockPrice, discountCurve,
                                      dividendYield, model, numPaths, seed, useSobolInt)
        end = time.time()
        duration = end - start

        print("%10d %9.5f %9.5f %9.6f" % (numPaths, value, value_mc, duration))
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = callOption.value_mc_NUMPY_ONLY(valueDate, stockPrice, discountCurve,
                                     dividendYield, model, numPaths, seed, useSobolInt)
        end = time.time()
        duration = end - start
...
#    print(speedUp)
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = callOption.value_mc_NUMPY_NUMBA(valueDate, stockPrice, discountCurve,
                                     dividendYield, model, numPaths, seed, useSobolInt)
        end = time.time()
        duration = end - start
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = callOption.value_mc_NUMBA_ONLY(valueDate, stockPrice, discountCurve,
                                     dividendYield, model, numPaths, seed, useSobolInt)
        end = time.time()
        duration = end - start
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        value_mc = callOption.value_mc_NUMBA_PARALLEL(valueDate, stockPrice, discountCurve,
                                     dividendYield, model, numPaths, seed, useSobolInt)
        end = time.time()
        duration = end - start
