...
# ============================================================================
# 1. BOND BOOTSTRAP DISCOUNT CURVE
# ============================================================================
...
acc_dc_type, freq_type, spot_days, ex_div_days, cal = get_bond_market_conventions(BondMarkets.UNITED_KINGDOM)
...
for interp_type in InterpTypes:
    ...
    bond_curve = BondBootstrapDiscountCurve(settle_dt, bonds, clean_prices, interp_type, check_refit_flag=True)

    elapsed = time.perf_counter() - start

    print("INTERPOLATION", "DATE", "ZERO RATE", "DISCOUNT_FACTOR", "TIME")
    ...
    for _, bond_row in bond_dataframe.iterrows():
        ...
        print(interp_type, maturity_dt, zero_rate * 100, df, elapsed)
