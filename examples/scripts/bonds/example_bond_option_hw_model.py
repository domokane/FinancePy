...
print("\n" + "=" * 78)
print("1. BOND OPTION DERIVA GEM")
print("=" * 78)
...
euro_call_bond_option = BondOption(bond, expiry_dt, strike_price, OptionTypes.EUROPEAN_CALL)
...
# Jamshidian approach
v_jam = model.european_bond_option_jamshidian(t_exp, strike_price, face, coupon_times, coupon_flows, times, dfs)
...
v_hw = model.bond_option(t_exp, strike_price, face, coupon_times, coupon_flows, exercise_type)

# ============================================================================
# 2. BOND OPTION ZEROVOL CONVERGENCE
# ============================================================================
# What this section demonstrates:
...
print("\n" + "=" * 78)
print("2. BOND OPTION ZEROVOL CONVERGENCE")
print("=" * 78)
...
# ============================================================================
# 4. BOND OPTION EUROPEAN CONVERGENCE
# ============================================================================
# What this section demonstrates:
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.
# The loop varies dates, parameters, instruments or conventions so their effect can be compared rather than relying on one isolated result.
...
print("\n" + "=" * 78)
print("4. BOND OPTION EUROPEAN CONVERGENCE")
print("=" * 78)
...
print("TIME", "N", "PUT_JAM", "PUT_TREE", "CALL_JAM", "CALL_TREE")
...
# ============================================================================
# 5. BOND OPTION AMERICAN CONVERGENCE ONE
# ============================================================================
# What this section demonstrates:
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.
# The loop varies dates, parameters, instruments or conventions so their effect can be compared rather than relying on one isolated result.
...
print("\n" + "=" * 78)
print("5. BOND OPTION AMERICAN CONVERGENCE ONE")
print("=" * 78)
...
# ============================================================================
# 6. BOND OPTION AMERICAN CONVERGENCE TWO
# ============================================================================
# What this section demonstrates:
# Values cash flows from the curve and reports the clean quoted price.
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.
...
print("\n" + "=" * 78)
print("6. BOND OPTION AMERICAN CONVERGENCE TWO")
print("=" * 78)
...
for num_steps in num_steps_vector:
    ...
    euro_call_bond_option = BondOption(bond, expiry_dt, k, OptionTypes.EUROPEAN_CALL)

    v_ec = euro_call_bond_option.value(settle_dt, discount_curve, hw_model)

    amer_call_bond_option = BondOption(bond, expiry_dt, k, OptionTypes.AMERICAN_CALL)
