...
# ============================================================================
# FINANCEPY EXAMPLES - NSSDiscountCurve
# ============================================================================
...
# ============================================================================
# 1. FIN NELSON SIEGEL SVENSSON CURVE
# ============================================================================
...
print("\n" + "=" * 78)
print("1. FIN NELSON SIEGEL SVENSSON CURVE")
print("=" * 78)
...
print("FACTOR LOADING ON ZERO RATES")
print(factor1loading)
print(factor2loading)
print(factor3loading)
print(factor4loading)
...
print("beta_1", "beta_2", "beta_3", "beta_4", "ZEROS")
...
print(beta_1, beta_2, beta_3, beta_4, zero_rates1)
...
print(beta_1, beta_2, beta_3, beta_4, zero_rates2)
...
print(beta_1, beta_2, beta_3, beta_4, zero_rates3)
...
print(beta_1, beta_2, beta_3, beta_4, zero_rates4)
...
print(beta_1, beta_2, beta_3, beta_4, zero_rates5)
