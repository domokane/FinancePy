...
fin_discount_curve = DiscountCurve(value_dt, dates, discount_factors, InterpTypes.FLAT_FWD_RATES)
...
fin_discount_curve_ns = NSDiscountCurve(value_dt, 0.0305, -0.01, 0.08, 10.0)
curves_list.append(fin_discount_curve_ns)

fin_discount_curve_nss = NSSDiscountCurve(value_dt, 0.035, -0.02, 0.09, 0.1, 1.0, 2.0)
curves_list.append(fin_discount_curve_nss)

fin_discount_curve_poly = PolyDiscountCurve(value_dt, [0.05, 0.002, -0.00005])
...
print("SINGLE CALLS NO VECTORS")
print("CURVE", "DATE", "ZERO", "DF", "CCFWD", "MMFWD", "SWAP")
...
zeros = np.array([0.05, 0.06, 0.065, 0.07, 0.075, 0.08, 0.081, 0.082, 0.083, 0.084])
