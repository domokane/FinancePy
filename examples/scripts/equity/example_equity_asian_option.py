...
print("K", "Geometric", "Turnbull_Wakeman", "Curran", "FastMC", "FastMC_CV")
...
print("NUMPATHS", "VALUE", "TIME", "VALUE_MC", "TIME", "VALUE_MC_CV", "TIME")
