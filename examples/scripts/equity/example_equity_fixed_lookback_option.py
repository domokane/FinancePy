# ============================================================================
# FINANCEPY EXAMPLES - EquityFixedLookbackOption
# ============================================================================
#
...
# ============================================================================
# 1. FIXED LOOKBACK CALL
# ============================================================================

print("\n" + "=" * 78)
print("1. FIXED LOOKBACK CALL")
print("=" * 78)

call_option = EquityFixedLookbackOption(
    expiry_dt, OptionTypes.EUROPEAN_CALL, strike_price
)
...
# ============================================================================
# 2. FIXED CALL - MONTE CARLO PATH CONVERGENCE
# ============================================================================

print("\n" + "=" * 78)
print("2. FIXED LOOKBACK CALL - MONTE CARLO PATH CONVERGENCE")
print("=" * 78)
...
plt.ylabel("Fixed Lookback Call Value")
plt.title("Fixed Lookback Call: Monte Carlo Path Convergence")
plt.grid(True)
plt.legend()
plt.show()

# ============================================================================
# 3. FIXED CALL - MONITORING-FREQUENCY CONVERGENCE
# ============================================================================

print("\n" + "=" * 78)
print("3. FIXED LOOKBACK CALL - OBSERVATION-FREQUENCY CONVERGENCE")
print("=" * 78)
...
plt.ylabel("Fixed Lookback Call Value")
plt.title("Fixed Lookback Call: Observation-Frequency Convergence")
plt.grid(True)
plt.legend()
plt.show()
...
plt.title("Fixed Lookback Call: Observation Error")
plt.grid(True)
plt.legend()
plt.show()
...
print("\n" + "=" * 78)
print("4. FIXED LOOKBACK PUT")
print("=" * 78)

put_option = EquityFixedLookbackOption(
    expiry_dt, OptionTypes.EUROPEAN_PUT, strike_price
)
stock_min_max = stock_price
...
# ============================================================================
# 5. FIXED PUT - MONITORING-FREQUENCY CONVERGENCE
# ============================================================================

print("\n" + "=" * 78)
print("5. FIXED LOOKBACK PUT - OBSERVATION-FREQUENCY CONVERGENCE")
print("=" * 78)
...
plt.ylabel("Fixed Lookback Put Value")
plt.title("Fixed Lookback Put: Observation-Frequency Convergence")
plt.grid(True)
plt.legend()
plt.show()
...
plt.axhline(0.0, linestyle="--", label="Zero Error")
plt.xlabel("Observation per Year")
plt.ylabel("MC Value - Analytic Value")
plt.title("Fixed Lookback Put: Observation Error")
plt.grid(True)
plt.legend()
plt.show()
...
print("6. SUMMARY")
print("=" * 78)
print(f"Fixed call analytic : {analytic_call:.10f}")
print(f"Fixed call MC       : {call_monitor_values[-1]:.10f}")
print(f"Fixed call error    : {call_errors[-1]:.10f}")
print()
print(f"Fixed put analytic  : {analytic_put:.10f}")
print(f"Fixed put MC        : {put_monitor_values[-1]:.10f}")
print(f"Fixed put error     : {put_errors[-1]:.10f}")
