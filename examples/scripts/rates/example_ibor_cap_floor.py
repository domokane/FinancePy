...
# ============================================================================
# FINANCEPY EXAMPLES - IborCapFloor
# ============================================================================
...
print("CORRECT PRICE", "MODEL_PRICE")
print(517.29, v_caplet)

# ============================================================================
# 2. IBOR CAP FLOOR VOL CURVE
# ============================================================================
# What this section demonstrates:
...
print("\n" + "=" * 78)
print("2. IBOR CAP FLOOR VOL CURVE")
print("=" * 78)
...
# Value cap by breaking it down into caplets using caplet vols
v_caplets = 0.0
caplet_start_dt = cap_floor.caplet_floorlet_dates[1]
print("START", "END", "VOL", "VALUE")
...
for caplet_end_dt in cap_floor.caplet_floorlet_dates[2:]:
    ...
    caplet_start_dt = caplet_end_dt

print("LABEL", "VALUE")
print("CAPLETS->CAP: ", v_caplets)
...
libor_curve = test_ibor_deposits_and_swaps(today_date)
...
for k in strikes:
    ...
    print("CAP", k, cvalue1, cvalue2, cvalue3, cvalue4, cvalue5, cvalue6)
...
for k in strikes:
    ...
    print("FLR", k, fvalue1, fvalue2, fvalue3, fvalue4, fvalue5, fvalue6)
...
print("\n" + "=" * 78)
print("4. IBOR CAP FLOOR QL EXAMPLE")
print("=" * 78)
