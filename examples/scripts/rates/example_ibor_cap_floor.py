...
def test_ibor_cap_floor_vol_curve():
...
def test_ibor_cap_floor_ql_example():
...
test_ibor_caplet_hull()
test_ibor_cap_floor_vol_curve()
test_ibor_cap_floor()
test_ibor_cap_floor_ql_example()
