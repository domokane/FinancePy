...
# ============================================================================
# FINANCEPY EXAMPLES - IborDeposit
# ============================================================================
...
for k in strikes:
    ...
    print("PAY", k, swap1, swap2, swap3, swap4, swap5, swap6)

print("LABEL", "STRIKE", "BLK", "BLK_SHFTD", "SABR", "SABR_SHFTD", "HW", "BK")
...
# ============================================================================
# 2. FIN IBOR CASH SETTLED SWAPTION
# ============================================================================
# What this section demonstrates:
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.

print("\n" + "=" * 78)
print("2. FIN IBOR CASH SETTLED SWAPTION")
print("=" * 78)
...
libor_curve = IborSingleCurve(value_dt, depos, [], swaps, InterpTypes.LINEAR_ZERO_RATES)
...
print("Curve Fwd Swap Rate:", fwd_swap_rate1)
...
print("Fwd Swap Swap Rate:", fwd_swap_rate2)
...
# ============================================================================
# 3. IBOR SWAPTION MATLAB EXAMPLES
# ============================================================================
# What this section demonstrates:
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.

print("\n" + "=" * 78)
print("3. IBOR SWAPTION MATLAB EXAMPLES")
print("=" * 78)
...
libor_curve = FlatDiscountCurve(value_dt, 0.06, FrequencyTypes.CONTINUOUS, DayCountTypes.THIRTY_E_360)
...
libor_curve = ZeroRatesDiscountCurve(value_dt, dates, zero_rates, cont_freq, dc_type, interp_type)
...
print("====================================")
print("MATLAB EXAMPLE WITH BLACK-DERMAN-TOY")
print("====================================")
...
# ============================================================================
# 4. IBOR SWAPTION QL EXAMPLE
# ============================================================================
# What this section demonstrates:
# Values the instrument using the supplied market data/model inputs. The surrounding comparison shows how the valuation responds to those assumptions.

print("\n" + "=" * 78)
print("4. IBOR SWAPTION QL EXAMPLE")
print("=" * 78)
