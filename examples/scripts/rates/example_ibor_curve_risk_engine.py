...
def test_par_rate_risk_report_cubic_zero():
    ...
    print("RISK REPORT CUBIC ZERO")
    print("ACTUAL_TOTALS", "EXPECTED TOTALS")
    for i in range(0, len(actual_totals)):
        print(actual_totals[i], expected_totals[i])
...
def test_par_rate_risk_report_flat_forward():
    ...
    print("RISK REPORT FLAT FORWARD REPORT")
    print("ACTUAL_TOTALS", "EXPECTED TOTALS")
    for i in range(0, len(actual_totals)):
        print(actual_totals[i], expected_totals[i])
...
def test_forward_rate_risk_report():
    ...
    print("FORWARD RATE RISK REPORT")
    print("ACTUAL_TOTALS", "EXPECTED TOTALS")
    for i in range(0, len(actual_totals)):
        print(actual_totals[i], expected_totals[i])
...
def test_parallel_shift_ladder_report():
    ...
    print("PARALLEL SHIFT LADDER REPORT")
    print("ACTUAL_TOTALS", "EXPECTED TOTALS")
    for i in range(0, len(actual_totals)):
        print(actual_totals[i], expected_totals[i])
