...
def test_swap_valuation_example():
    ...
    ibor_curve = IborSingleCurve(value_dt, ibor_depos, ibor_fras, ibor_swaps, interp_type)
    v1 = off_mkt_swap.value(value_dt, ibor_curve, ibor_curve, -0.268 / 100.0)

    print("DERISCOPE EXAMPLE REPLICATION")
    print("LABEL", "VALUE")
    print("BBG VALUE", v_bbg)
    print("FP ONE CURVE VALUE", v1)
    ...
    ibor_dual_curve = IborDualCurve(value_dt, ois_curve_ff, ibor_depos, ibor_fras, ibor_swaps, interp_type)
...
print("======================================================")
print("SINGLE CURVE VALUATION TO SWAP SETTLEMENT DATE")
print("LABEL", "VALUE")
print("VALUE:", swaps[0].value(settle_dt, libor_curve, libor_curve, None))
...
print("VALUE:", swaps[0].value(value_dt, ois_curve, libor_dual_curve, None))
print("FIXED:", swaps[0].fixed_leg.value(value_dt, ois_curve))
print(
    "FLOAT:",
    swaps[0].float_leg.value(value_dt, ois_curve, libor_curve, None),
)

print("VALUATION TO SWAP SETTLEMENT DATE", " PV")
print("VALUE:", swaps[0].value(settle_dt, ois_curve, libor_dual_curve, None))
