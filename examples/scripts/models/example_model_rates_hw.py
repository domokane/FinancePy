...
# ============================================================================
# FINANCEPY EXAMPLES - Model Rates Hw
# ============================================================================
...
print("\n" + "=" * 78)
print("1. HULL WHITE EXAMPLE ONE")
print("=" * 78)
...
print("\n" + "=" * 78)
print("2. HULL WHITE EXAMPLE TWO")
print("=" * 78)
...
print("Comparing option on zero coupon bond analytical vs Tree")
...
# ============================================================================
# 3. HULL WHITE BOND OPTION
# ============================================================================
# What this section demonstrates:
# The loop varies dates, parameters, instruments or conventions so their effect can be compared rather than relying on one isolated result.

print("\n" + "=" * 78)
print("3. HULL WHITE BOND OPTION")
print("=" * 78)
...
v_jam = model.european_bond_option_jamshidian(t_exp, strike_price, face, cpn_times, cpn_flows, times, dfs)

print("Pricing bond option on tree to maturity using european bond option tree that goes to expiry.")

print("NUMSTEPS", "TIME", "EXPIRY_ONLY", "EXPIRY_TREE", "JAMSHIDIAN")
...
for num_time_steps in num_steps_list:
    ...
    v1 = model.bond_option(t_exp, strike_price, face, cpn_times, cpn_flows, exercise_type)

    model = HWTree(sigma, a, num_time_steps, HWEuropeanCalcTypes.EXPIRY_TREE)
    model.build_tree(t_exp, times, dfs)

    v2 = model.bond_option(t_exp, strike_price, face, cpn_times, cpn_flows, exercise_type)

    end = time.time()
    period = end - start

    print(num_time_steps, period, v1, v2, v_jam)
...
print("\n" + "=" * 78)
print("4. HULL WHITE CALLABLE BOND")
print("=" * 78)
...
print("NUMSTEPS", "TIME", "BOND_ONLY", "CALLABLE_BOND")
...
for num_time_steps in num_steps_list:
    ...
    period = end - start
    print(num_time_steps, period, v1, v2)
