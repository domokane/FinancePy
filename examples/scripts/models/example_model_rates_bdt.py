...
print("\n" + "=" * 78)
print("2. BDT EXAMPLE TWO")
print("=" * 78)

print("===================== FIG 28.11 HULL BOOK =============")
...
print("\n" + "=" * 78)
print("3. BDT EXAMPLE THREE")
print("=" * 78)

print("===================== ANDERSEN PAPER ==============")
...
for exercise_type in [
    ...
    for years_to_maturity in [4.0, 5.0, 10.0, 20.0]:
        ...
        for expiry_years in range(int(years_to_maturity / 2) - 1, int(years_to_maturity)):
