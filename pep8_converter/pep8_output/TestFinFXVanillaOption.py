...
def test__fin_fx_vanilla_option_hull_example():
...
def test__fin_fx_vanilla_option_sabr_example():
...
test__fin_fx_vanilla_option_wystup_example1()
test__fin_fx_vanilla_option_wystup_example2()
test__fin_fx_vanilla_option_bloomberg_example()
test__fin_fx_vanilla_option_hull_example()
test__fin_fx_vanilla_option_sabr_example()
