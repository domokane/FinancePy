...
def test__fin_schedule_alignment(eom_flag):
...
def test__fin_schedule_alignment_leap_year_eom():
...
def test__fin_schedule_alignment_leap_year_not_eom():
...
def test__fin_schedule_alignment_eff31():
...
test__fin_schedule()
test__fin_schedule_alignment(True)
test__fin_schedule_alignment(False)

test__fin_schedule_alignment_leap_year_eom()
test__fin_schedule_alignment_leap_year_not_eom()

test__fin_schedule_alignment_eff31()
