...
def test__bond_futures_cme_two_bond_examples():
...
def test__bond_futures_cme_table():
...
def test__bond_futures_bbg_table():
...
# test__bond_futures()
# test__bond_futures_cme_two_bond_examples()
test__bond_futures_cme_table()
test__bond_futures_bbg_table()
