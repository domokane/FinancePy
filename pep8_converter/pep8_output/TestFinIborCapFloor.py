...
def test__ibor_cap_floor_vol_curve():
...
def test__ibor_cap_floor_ql_example():
...
test__ibor_caplet_hull()
test__ibor_cap_floor_vol_curve()
test__ibor_cap_floor()
test__ibor_cap_floor_ql_example()
