...
def test__hull_book_examples():
    ...
    v_sticky_caplets = (
        lmm_sticky_caplet_pricer(spread, num_fwds, num_paths, fwd0, fwds1_f, taus) * 100.0
    )
    ...
    v_sticky_caplets = (
        lmm_sticky_caplet_pricer(spread, num_fwds, num_paths, fwd0, fwds2_f, taus) * 100.0
    )
    ...
    v_sticky_caplets = (
        lmm_sticky_caplet_pricer(spread, num_fwds, num_paths, fwd0, fwds3_f, taus) * 100.0
    )
