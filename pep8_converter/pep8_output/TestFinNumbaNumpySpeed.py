...
def test__fin_numba_numpy_speed(use_sobol):
...
def test__fin_numba_numba_parallel(use_sobol):
...
if 1 == 0:
    test__fin_numba_numpy_speed(False)
    test__fin_numba_numpy_speed(True)

################################################################################

if 1 == 0:
    test__fin_numba_numba_parallel(False)
    test__fin_numba_numba_parallel(True)
