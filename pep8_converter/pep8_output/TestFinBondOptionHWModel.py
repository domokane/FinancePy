...
def test__bond_option_european_convergence():
...
def test__bond_option_american_convergence_one():
...
def test__bond_option_american_convergence_two():
...
def test__bond_option_zerovol_convergence():
...
def test__bond_option_deriva_gem():
...
test__bond_option_deriva_gem()

test__bond_option_zerovol_convergence()
test__bond_option()
test__bond_option_european_convergence()
test__bond_option_american_convergence_one()
test__bond_option_american_convergence_two()
