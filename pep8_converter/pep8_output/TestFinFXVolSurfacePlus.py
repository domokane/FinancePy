...
def test__fin_fx_mkt_vol_surface1(verbose_calibration):
...
def test__fin_fx_mkt_vol_surface2(verbose_calibration):
...
def test__fin_fx_mkt_vol_surface3(verbose_calibration):
...
def test__fin_fx_mkt_vol_surface4(verbose_calibration):
...
def test__fin_fx_mkt_vol_surface5(verbose_calibration):
...
if __name__ == "__main__":
    ...
    test__fin_fx_mkt_vol_surface1(verbose_calibration)
    test__fin_fx_mkt_vol_surface2(verbose_calibration)
    test__fin_fx_mkt_vol_surface3(verbose_calibration)
    test__fin_fx_mkt_vol_surface4(verbose_calibration)
    test__fin_fx_mkt_vol_surface5(verbose_calibration)
