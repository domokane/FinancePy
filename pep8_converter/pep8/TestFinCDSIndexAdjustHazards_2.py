...
def test_performCDSIndexHazardRateAdjustment():
    ...
    test_cases.print("AVERAGE SPD 3Y", average_spd3_y)
    test_cases.print("AVERAGE SPD 5Y", average_spd5_y)
    test_cases.print("AVERAGE SPD 7Y", average_spd7_y)
    test_cases.print("AVERAGE SPD 10Y", average_spd10_y)
    test_cases.banner(
        "==================================================================="
    )
    ...
    #            unadjusted_spread = cds.par_spread(value_dt,issuer_curves[m])
    #            adjusted_spread = cds.par_spread(value_dt,adjusted_issuer_curves[m])
    #            test_cases.print(m,str(cds.maturity_dt),"%10.3f"%(unadjusted_spread*10000),"%10.3f" %(adjusted_spread*10000))
