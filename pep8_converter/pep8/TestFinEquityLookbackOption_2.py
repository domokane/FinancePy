...
def test_EquityLookBackOption():
    ...
    for stock_price in stock_price_range:
        for num_paths in num_paths_range:
            option = EquityFloatLookbackOption(expiry_dt, opt_type)
...
def test_example():
    ...
    lookback_call = EquityFixedLookbackOption(expiry_dt, opt_typeCall, strike_price)
    lookback_put = EquityFixedLookbackOption(expiry_dt, opt_typePut, strike_price)
