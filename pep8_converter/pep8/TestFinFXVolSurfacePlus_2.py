...
def test_FinFXMktVolSurface1(verbose_calibration):
...
def test_FinFXMktVolSurface2(verbose_calibration):
...
def test_FinFXMktVolSurface3(verbose_calibration):
...
def test_FinFXMktVolSurface4(verbose_calibration):
...
def test_FinFXMktVolSurface5(verbose_calibration):
...
if __name__ == "__main__":
    ...
    test_FinFXMktVolSurface1(verbose_calibration)
    test_FinFXMktVolSurface2(verbose_calibration)
    test_FinFXMktVolSurface3(verbose_calibration)
    test_FinFXMktVolSurface4(verbose_calibration)
    test_FinFXMktVolSurface5(verbose_calibration)
