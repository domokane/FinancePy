...
def test_FinNelsonSiegelSvenssonCurve():
    ...
    #    plt.plot(times,scale_vector(factor1loading,1),label='beta_1');
    #    plt.plot(times,scale_vector(factor2loading,1),label='beta_2');
    #    plt.plot(times,scale_vector(factor3loading,1),label='beta_3');
    #    plt.ylim((0,1.05))
    #
