...
################################################################################
    ...
    def expMinLK(self, K):
        ...
        term1 = M(c, a, self._beta) + phi3(b, c, c0, r12, r13, r23) - phi3(a, c, c0, r12, r13, r23)
...
################################################################################
    ...
    def expMinLK2(self, K):
        ...
        el1 = self._P * self._H * (1.0 - self._R) + self._P0 * self._H0 * (1.0 - self._R0)
        el1 = el1 - K * (M(c0, a, self._beta0) - N(a))
        el1 = el1 - ((1.0 - self._R0) * self._H0 - K) * M(c0, b, self._beta0)

        term = M(c, a, self._beta) + phi3(b, c, c0, r12, r13, r23) - phi3(a, c, c0, r12, r13, r23)
