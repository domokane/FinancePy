...
################################################################################
    ...
    def valueLegs_MC(self, 
        ...
        for iTime in range(1,numFlows):
            ...
            rpv01ToTimes[iTime] = rpv01ToTimes[iTime - 1] + accrualFactor * liborCurve.df(t)
    ...
    def value1FGaussian_Homo(self, 
        ...
        for iTime in range(1,numTimes):
           ...
           for iCredit in range(0,numCredits):            
                ...
                issuerSurvivalProbabilities[iCredit] = interpolate(t, 
                                                   issuerCurve._times, 
                                                   issuerCurve._values, 
        ...
        protLegPV = self._cdsContract.protectionLegPV(valuationDate, basketCurve, curveRecovery)
