...
class FinOption(object):
    ...
    def delta(self, valueDate, stockPrice, interestRate, dividendYield, volatility ):
        v = self.value(valueDate, stockPrice, interestRate, dividendYield, volatility)
        vBumped = self.value(valueDate, stockPrice + bump, interestRate, dividendYield, volatility)
        delta = (vBumped - v)/bump
        return delta

    def gamma(self, valueDate, stockPrice, interestRate, dividendYield, volatility ):
        v = self.delta(valueDate, stockPrice, interestRate, dividendYield, volatility )
        vBumped = self.delta(valueDate, stockPrice + bump, interestRate, dividendYield, volatility)
        gamma = (vBumped - v)/bump
        return gamma

    def vega(self, valueDate, stockPrice, interestRate, dividendYield, volatility):
        v = self.value(valueDate, stockPrice, interestRate, dividendYield, volatility)
        vBumped = self.value(valueDate, stockPrice, interestRate, dividendYield, volatility + bump)
        vega = (vBumped - v)/bump
        return vega
    ...
    def theta(self, valueDate, stockPrice, interestRate, dividendYield, volatility ):
        ...
        vBumped = self.value(nextDate, stockPrice, interestRate, dividendYield, volatility )
        theta = (vBumped - v)/bump
        return theta

    def rho(self, valueDate, stockPrice, interestRate, dividendYield, volatility):
        v = self.value(valueDate, stockPrice, interestRate, dividendYield, volatility)
        vBumped = self.value(valueDate, stockPrice, interestRate+bump, dividendYield, volatility)
        rho = (vBumped - v)/bump
        return rho
