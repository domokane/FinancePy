...
from financepy.finutils.FinCalendar import FinDateGenRuleTypes, FinBusDayConventionTypes
...
def test_FinAnnuity():
    ...
    annuity = FinAnnuity(d1, d2,frequencyType,calendarType,busDayAdjustType,dateGenRuleType,basisType)
#    annuity.dump()
