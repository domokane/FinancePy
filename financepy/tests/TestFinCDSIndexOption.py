...
def test_fullPriceCDSIndexOption():
    ...
    testCases.banner("======================= CDS INDEX OPTION ==========================")
    ...
    testCases.header("TIME","STRIKE","INDEX","PAYER","RECEIVER","G(K)","X","EXPH","ABPAY","ABREC")
    ...
    for index in np.linspace(20,60,5):
        ...
        for strike in np.linspace(20,60,5):
            ...
            testCases.print(elapsed,strike,index,v_pay_1,v_rec_1,strikeValue,mu,expH,v_pay_2,v_rec_2)
