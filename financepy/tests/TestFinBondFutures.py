...
def test_FinBondFuture():
    ...
    # Example from https://www.cmegroup.com/education/files/understanding-treasury-futures.pdf
    ...
    bonds.append(bond)
    prices.append(98+1/32)  # There may be an error in the document says 98-01+
