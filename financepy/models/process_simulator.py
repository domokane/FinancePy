...
class FinProcessSimulator:
    ...
    def get_process(
        ...
        if process_type == ProcessTypes.GBM_PROCESS:
        ...
        elif process_type == ProcessTypes.HESTON_PROCESS:
        ...
        elif process_type == ProcessTypes.VASICEK_PROCESS:
        ...
        elif process_type == ProcessTypes.CIR_PROCESS:
            (r0, kappa, theta, sigma, scheme) = model_params
            paths = get_cir_paths(
                num_paths,
                num_annual_steps,
