...
class FinFixedFlow(object):
    ''' A FinFixedCashFlow is a quantity of cash paid at some time where the
    quantity is based on an interest rate, an accrual period, a notional
    size and a currency. '''
