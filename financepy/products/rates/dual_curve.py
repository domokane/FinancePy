...
###############################################################################
    ...
    def _validate_inputs(self,
        ...
        if num_swaps > 1:
            ...
            longest_swap_cpn_dts = longest_swap._fixed_leg._payment_dts
            for swap in ibor_swaps[0:-1]:
                swap_cpn_dts = swap._fixed_leg._payment_dts
        ...
        if num_fras > 0:
            first_fra_maturity_dt = ibor_fras[0]._maturity_dt
            last_fra_maturity_dt = ibor_fras[-1]._maturity_dt
        ...
        self._used_deposits = ibor_deposits
        self._used_fras = ibor_fras
        self._used_swaps = ibor_swaps
...
###############################################################################
    ...
    #     for dt in cpn_dts[1:]:
    #         swap_years = (dt - self._value_dt) / gDaysInYear
    ...
    #     accrual_factors = longest_swap._fixedYearFracs

    #     acc = 0.0
    #     df = 1.0
    #     pv01 = 0.0
    #     df_settle = self.df(longest_swap._effective_dt)
