...
def forward_rate_risk_report(
    ...
    """
    value_date = base_curve.anchor_dt
    grid, grid_labels = _grid_from_dates_tenor(grid_last_date, grid_bucket_tenor, value_date)
...
def _grid_from_dates_tenor(grid_last_date, grid_bucket_tenor: Union[str, Tenor], value_date):
