...
class OISBasisSwap:
    ...
    def __init__(
        ...
        ibor_dc_type: DayCountTypes = DayCountTypes.THIRTY_E_360,
        ibor_spread: float = 0.0,
        ois_freq_type: FrequencyTypes = FrequencyTypes.QUARTERLY,
        ois_dc_type: DayCountTypes = DayCountTypes.THIRTY_E_360,
        ...
        self.float_ibor_leg = SwapFloatLeg(
            effective_dt,
            self.termination_dt,
            ibor_type,
            ibor_spread,
        ...
        self.float_ois_leg = SwapFloatLeg(
            effective_dt,
            self.termination_dt,
            ois_type,
            ois_spread,
    ...
    def value(
        ...
        float_ois_leg_value = self.float_ois_leg.value(
            value_dt, discount_curve, index_ois_curve, first_fixing_rate_leg_2
        )
