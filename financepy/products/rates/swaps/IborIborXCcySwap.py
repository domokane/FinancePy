...
class IborIborXCcySwap:
    ...
    def __init__(
        ...
        self.first_fixing_rate = None
        self.value_dt = None
        self.fixed_start_index = None
    ...
    def pv01(self, value_dt, discount_curve):
        ...
        pv01 = pv / self.fixed_cpn / self.notional
        return pv01
    ...
    def fixed_leg_value(self, value_dt, discount_curve, principal=0.0):
        ...
        day_counter = DayCount(self.fixed_dc_type)
        ...
        for next_dt in self._adjusted_fixed_dts[start_index:]:
            ...
            flow = self.fixed_cpn * alpha * self.notional
    ...
    def print_fixed_leg_pv(self):
        ...
        print("COUPON (%):", self.fixed_cpn * 100)
        print("FIXED LEG FREQUENCY:", str(self.fixed_freq_type))
        print("FIXED LEG DAY COUNT:", str(self.fixed_dc_type))
    ...
    def print_float_leg_pv(self):
        ...
        print("START DATE:", self.effective_dt)
        print("MATURITY DATE:", self.maturity_dt)
        print("SPREAD COUPON (%):", self.float_spread * 100)
