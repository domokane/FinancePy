...
from ...products.ibor_deposit import IborDeposit
from ...products.ibor_fra import IborFRA
from ...products.ibor_swap import IborSwap
...
class IborDualCurve(DiscountCurve):
    ...
    def __init__(
        ...
        print("Deprecation Warning: IborDualCurve has moved to market->curves folder. This version will be removed.")
