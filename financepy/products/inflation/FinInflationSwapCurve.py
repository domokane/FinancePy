...
###############################################################################
    ...
    def _validate_inputs(self,
        ...
        if num_swaps > 1:
            ...
            start_dt = ibor_swaps[0]._start_dt
            for swap in ibor_swaps[1:]:
                next_start_dt = swap._start_dt
            ...
            longest_swap_cpn_dts = longest_swap._adjusted_fixed_dts
            for swap in ibor_swaps[0:-1]:
                swap_cpn_dts = swap._adjusted_fixed_dts
...
#        print(self._dfs)
        ...
        coupon_dts = longest_swap._adjusted_fixed_dts
