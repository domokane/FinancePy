...
class FinInflationYTMCalcType(Enum):
    UK_DMO = 1,
    US_STREET = 2,
    US_TREASURY = 3
...
###############################################################################
    ...
    def fullPriceFromRealYTM(self,
                             ...
                             ytm: float,
                             convention: FinInflationYTMCalcType \
        ...
        if convention not in FinInflationYTMCalcType:
        ...
        if convention == FinInflationYTMCalcType.UK_DMO:
        ...
        elif convention == FinInflationYTMCalcType.US_TREASURY:
        ...
        elif convention == FinInflationYTMCalcType.US_STREET:
...
###############################################################################
    ...
    def dollarDuration(self,
                       settlementDate: FinDate,
                       ytm: float,
                       convention: FinInflationYTMCalcType = FinInflationYTMCalcType.UK_DMO):
...
###############################################################################
    ...
    def cleanPriceFromRealYTM(self,
                              settlementDate: FinDate,
                              ytm: float,
                              convention: FinInflationYTMCalcType \
                                  = FinInflationYTMCalcType.UK_DMO):
