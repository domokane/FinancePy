...
class FinFixedLookbackOptionTypes(Enum):
    FIXED_CALL = 1
    FIXED_PUT = 2
...
##########################################################################
    ...
    def value(self,
        ...
        if self._optionType == FinFixedLookbackOptionTypes.FIXED_CALL:
            smax = stockMinMax
            if smax < s0:
                raise FinError(
                    "The Smax value must be >= the stock price.")
        elif self._optionType == FinFixedLookbackOptionTypes.FIXED_PUT:
            smin = stockMinMax
            if smin > s0:
                raise FinError(
