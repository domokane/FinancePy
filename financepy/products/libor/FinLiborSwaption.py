...
class FinLiborSwaption():
    ...
    def __init__(self, 
        ...
        if swapFixedDayCountType not in FinDayCountTypes:
            raise FinError("Unknown Fixed DayCountRule type " + str(swapFixedDayCountType))

        if swapFixedFrequencyType not in FinFrequencyTypes:
            raise FinError("Unknown Fixed Frequency type " + str(swapFixedFrequencyType))
    ...
    def value(self, 
        ...
        if modelType == FinLiborSwaptionModelTypes.BLACK:
            ...
            if self._swaptionType == FinLiborSwaptionType.PAYER:
                ...
                raise FinError("Unknown swaption option type" + str(self._optionType))
